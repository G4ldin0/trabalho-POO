...
public class RegistroConsultasAdminController implements Initializable {
    ...
    @FXML private TableColumn<ConsultaDTO, String> columnId;
    @FXML private TableColumn<ConsultaDTO, ConsultaDTO> columnEmitirProntuario;
    @FXML private TableColumn<ConsultaDTO, ConsultaDTO> columnEdit;
    @FXML private TableColumn<ConsultaDTO, ConsultaDTO> columnDelete;
    ...
    public void listarConsultas() {
        ...
        //columnId.setCellValueFactory(new PropertyValueFactory<>("idConsulta"));
        ...
        UtilsController.initButtons(columnDelete, 18, pathIconExcluir, "icon-svg-excluir", (ConsultaDTO consDTO, ActionEvent event) -> {
    ...
    public void editar() {
    	...
    	dto.setIdPaciente(tabelaConsultas.getSelectionModel().getSelectedItem().getIdPaciente());
    	dto.setIdMedico(tabelaConsultas.getSelectionModel().getSelectedItem().getIdMedico());

    	EditarConsultaController.telaEditar(dto);
