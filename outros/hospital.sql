...
use hospital;
CREATE TABLE Medico (nome VARCHAR(40),endereco VARCHAR(50),cpf VARCHAR(15) NOT NULL,codConselho INT,valorConsulta DOUBLE, idMedico INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(idMedico));
CREATE TABLE Paciente(nome VARCHAR(40),endereco VARCHAR(50), cpf bigint NOT NULL,idPaciente INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(idPaciente));
