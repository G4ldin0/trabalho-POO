...
CREATE TABLE Consulta(idPaciente INT NOT NULL,dia DATE, horario TIME, idMedico INT NOT NULL, idProntuario INT NOT NULL, idConsulta INT NOT NULL AUTO_INCREMENT,
