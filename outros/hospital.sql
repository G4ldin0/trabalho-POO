...
CREATE TABLE IF NOT EXISTS Consulta(dia DATE, horario TIME,idPaciente INT NOT NULL, idMedico INT NOT NULL, idConsulta INT NOT NULL AUTO_INCREMENT,PRIMARY KEY(idConsulta), FOREIGN KEY(idPaciente) REFERENCES Paciente(idPaciente),FOREIGN KEY(idMedico) REFERENCES Medico(idMedico));
